  ...
  return (
    ...
    >
      ...
      <div className="h-0.5 w-full bg-surface-sunken">
        <div
          className="h-full bg-live transition-[width] duration-1000 ease-linear"
...
function Line({
  ...
  return (
    <div className="flex items-center gap-2.5">
      ...
      <span className="min-w-0 flex-1 truncate font-display text-md font-semibold">
        {team.name}
      </span>
      <span className="w-6 text-right font-display text-2xl font-black tabular tracking-tight">
        {score}
      </span>
    </div>
  );

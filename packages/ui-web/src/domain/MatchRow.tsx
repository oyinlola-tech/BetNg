  ...
  return (
    ...
    >
      ...
      <div className="text-right text-xs text-text-muted">
        {match.phase === "BETTING_OPEN" && (
          <span className="rounded-xs bg-brand-subtle px-1.5 py-0.5 font-semibold text-brand">
            {match.openMarkets} markets
          </span>
        )}
      </div>
      <ChevronRight
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      {showScore && (
        <span
          className={cn(
            "w-4 text-right text-base tabular",
            strong

/**
 * The BetNG logomark: a rounded square carrying a "B" whose counters are cut by
 * a rising diagonal — the ball's path — so the mark reads as sport at 16px and
 * as a monogram at 160px. Original work; no third-party marks are used anywhere.
 */

export const LOGO_VIEWBOX = "0 0 64 64";

/** Background square, drawn in the brand colour. */
export const LOGO_TILE_PATH = "M14 0h36c7.7 0 14 6.3 14 14v36c0 7.7-6.3 14-14 14H14C6.3 64 0 57.7 0 50V14C0 6.3 6.3 0 14 0z";

/** The "B" with its diagonal cut, drawn in white (or the on-brand colour). */
...
/** The diagonal cut that crosses the B, drawn in the tile colour so it reads as a slice. */

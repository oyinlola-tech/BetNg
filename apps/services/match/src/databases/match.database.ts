 ...
 *
 * The service connects to `MATCH_DATABASE_URL` and to nothing else,
 * with a login that has rights to leagues, teams, fixtures, matches and match events and no other service's tables. The

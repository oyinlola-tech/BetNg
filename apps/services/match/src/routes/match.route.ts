...
export function registerMatchRoutes(router: HttpRouter, controller: MatchController): void {
  router.get(`${API_PREFIX}/leagues`, json(controller.listLeagues));
  router.get(`${API_PREFIX}/leagues/:id/standings`, json(controller.getStandings));
  ...
  router.get(`${API_PREFIX}/matches/:id/events`, json(controller.listMatchEvents));
...
export function registerAdminRoutes(router: HttpRouter, controller: AdminController): void {
  ...
  router.post(`${API_PREFIX}/admin/fixtures`, created(controller.createFixture));
  router.get(`${API_PREFIX}/admin/matches/:id`, json(controller.getMatch));
  router.post(`${API_PREFIX}/admin/matches/:id/actions`, json(controller.performMatchAction));
}

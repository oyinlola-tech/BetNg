...
export const IDENTITY_COMMAND = Object.freeze({
  ...
  CREATE_ADMIN: "identity.createAdmin",
  UPDATE_ADMIN: "identity.updateAdmin",
  SET_ADMIN_STATUS: "identity.setAdminStatus",
  RESET_ADMIN_CREDENTIALS: "identity.resetAdminCredentials",
  START_ADMIN_ACTIVATION: "identity.startAdminActivation",
  ACTIVATE_ADMIN: "identity.activateAdmin",
  ...
  SUBMIT_SHOP_APPLICATION: "identity.submitShopApplication",
  VERIFY_SHOP_APPLICATION_EMAIL: "identity.verifyShopApplicationEmail",
  REVIEW_SHOP_APPLICATION: "identity.reviewShopApplication",
  ...
  CREATE_SHOP_CASHIER: "identity.createShopCashier",
  SET_SHOP_CASHIER_STATUS: "identity.setShopCashierStatus",
  RESET_SHOP_CASHIER_CREDENTIALS: "identity.resetShopCashierCredentials",
...
export const IDENTITY_QUERY = Object.freeze({
  LIST_ADMINS: "identity.listAdmins",
  LIST_SHOP_APPLICATIONS: "identity.listShopApplications",
  GET_SHOP_APPLICATION: "identity.getShopApplication",
  GET_SHOP_APPLICATION_STATUS: "identity.getShopApplicationStatus",
...
export const AUDIT_ACTION = Object.freeze({
  ...
  ADMIN_CREDENTIALS_RESET: "admin_credentials_reset",
  ...
  SHOP_APPLICATION_SUBMITTED: "shop_application_submitted",
  SHOP_APPLICATION_REVIEWED: "shop_application_reviewed",
...
export const LIST_LIMIT = Object.freeze({
  ...
  CUSTOMERS: 200,
  SHOPS: 500,
  SHOP_APPLICATIONS: 200,
  SHOP_APPLICATION_DOCUMENTS: 8,
  CASHIERS: 200,

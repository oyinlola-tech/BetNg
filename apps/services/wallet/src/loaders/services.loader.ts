...
import { registerWalletService } from "../services/index.js";

/** The buses the wallet controller dispatches through. */
export interface WalletBuses {
 ...
 */
export function loadServices(container: Container): WalletBuses {
  const commandBus = createCommandBus();
  const queryBus = createQueryBus();

  registerWalletService({ container, commandBus, queryBus });

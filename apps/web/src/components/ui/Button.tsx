...
const VARIANTS: Record<ButtonVariant, string> = {
  ...
  secondary: "bg-surface border border-border-strong text-text-primary hover:bg-surface-hover",
...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(function Button(
  { variant = "primary", size = "md", loading = false, icon, full = false, className, children, disabled, ...rest },
  ref,
) {
  return (
    <button
